...
<%
	...
	System.out.println("RequestProforma - dealerID =>>>" + dealerID);
...
<aui:form action="<%=RequestProformaURL%>" name="<portlet:namespace />fm">
	<aui:fieldset-group markupView="lexicon">
		...
		<aui:fieldset>
			...
			<aui:input name="userEmail" title="userEmail" value="<%=userEmail%>" type="hidden"/>
			<aui:input name="carNo" title="ID Automobil" value="<%=carNo%>" type="hidden" />
			<aui:input name="dealerID" title="ID Dealer" value="<%=dealerID%>" type="hidden" />
